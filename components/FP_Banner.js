    ...
    <div className="relative h-64  overflow-hidden bg-sky-300">
      <div className="absolute z-30 flex w-full h-full">
        <div className="relative z-10 w-5/6 px-6 py-8 text-sbtOrange md:py-10 md:w-1/2">
          <h2 className="text-5xl p-4">{bannerItems.title}</h2>
         
          
          <p className="text-base p-4">{bannerItems.description} </p>
          <button
            className="text-sbtOrange bg-sbtBlue border border-solid border-sbtOrange hover:bg-sbtOrange hover:text-white active:bg-sbtOrange font-normal w-40  text-xl p-4 py-2 rounded outline-none focus:outline-none mr-1 mb-1   ease-linear transition-all duration-150"
            type="button"
          >
            Learn more
          </button> 
