...
export default function Footer() {
  return (
    <div className="pb-10 mt-4 bg-gray-200">
    <FooterSponsors />
      <footer className="pb-10 mt-4">
        
          <div className="flex flex-wrap md:text-left text-center order-first bgcolor">
              ...
              <nav className="list-none mb-10">
                <li>
                  ...
                  <Link href="/SignupForm">
                    <a className="text-xl text-gray-600 hover:text-bold hover:text-sbtOrange hover:underline">
                      Subscribe
                    </a>
                  </Link>
                </li>
